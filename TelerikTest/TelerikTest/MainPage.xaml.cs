...
namespace TelerikTest
{
    ...
    public sealed partial class MainPage : Page
    {
        ...
        private void ToPieChart_Click(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
        ...
        private void CartesianChart_Click(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                this.Frame.Navigate(typeof(CartesianChart));
            }
        }
        ...
        private void Button_Click_5(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                this.Frame.Navigate(typeof(Free));
            }
        }
        ...
        private void Button_Click_6(object sender, RoutedEventArgs e)
        {
            if (this.Frame != null)
            {
                this.Frame.Navigate(typeof(Apparel_Total));
            }
        }
    }
}

...
namespace UnitTestProject1
{
    public class CNDate
    {
        ...
        /// <param name="bLeap">是否為閏月</param>
        /// <returns></returns>
        public string FormatMonth(ushort iMonth, bool bLunar, bool bLeap)
        {
            ...
            if (iMonth == 11)
            {
                strMonth = strMonth + "十一";
            }
            else
            {
                strMonth = strMonth + "十二";
            }
            return strMonth + "月";
        }
        ...
        public DateTime GetLunarNewYearDate()
        {
            ...
            l_CalcLunarDate(out iYear, out iMonth, out iDay, out bLeap, (uint)(ts.Days));
            ...
            {
                uint tmp = LunarMonthDays(iYear, i);
        ...
        public string GetLunarHolDay()
        {
            ...
            else
            {
                ts = m_Date - (new DateTime(START_YEAR, 1, 1));
                l_CalcLunarDate(out iYear, out iMonth, out iDay, out bLeap, (uint)(ts.Days));
                return FormatMonth(iMonth, true, bLeap) + FormatLunarDay(iDay);
            }
        }
        ...
        /// <param name="bLeap">傳出是否為閏月</param>
        /// <param name="iSpanDays">傳入從 1901/1/1 之後的天數</param>
        public void l_CalcLunarDate(out ushort iYear, out ushort iMonth, out ushort iDay, out bool bLeap, uint iSpanDays)
        {
            bLeap = false;
            ...
            //計算月
            tmp = LunarMonthDays(iYear, iMonth) & 0xFFFF; //取低位
            while (iSpanDays >= tmp)
            {
                iSpanDays = iSpanDays - tmp;
